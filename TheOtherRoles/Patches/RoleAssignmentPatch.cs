...
namespace TheOtherRoles.Patches {
    ...
    class SetInfectedPatch
    {
        ...
        private static RoleAssignmentData getRoleAssignmentData() {
            ...
            impSettings.Add((byte)RoleId.Torturer, CustomOptionHolder.torturerSpawnRate.getSelection());
            ...
            crewSettings.Add((byte)RoleId.TheBait, CustomOptionHolder.theBaitSpawnRate.getSelection());
